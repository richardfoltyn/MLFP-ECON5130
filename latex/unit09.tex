\documentclass{scrartcl}
    ...
    % Document parameters
    % Document title
    \newcommand*{\mytitle}{Unit 9: Introduction to unsupervised learning}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_5_1.pdf}
    \end{center}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.lines.Line2D at 0x7f7c1bfea530>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_11_1.pdf}
    \end{center}
...
\subsubsection{Example: Higher-dimensional
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_27_1.pdf}
    \end{center}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_33_0.pdf}
    \end{center}
...
\subparagraph{Manually selecting the number of principle
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_39_0.pdf}
    \end{center}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_41_1.pdf}
    \end{center}
    
    \hypertarget{automatically-selecting-the-number-of-principal-components}{%
\subparagraph{Automatically selecting the number of principal
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit09_files/unit09_47_1.pdf}
    \end{center}
